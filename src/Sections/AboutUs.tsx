  ...
  return (
    <section 
      ...
      <div className="flex flex-col items-center text-center md:hidden relative z-10 h-screen overflow-hidden">
        ...
        />
        {/* Leaf — hidden on screens ≤342px and hidden between 640px and 1024px */}
        <img
          src={Leaf}
          alt="Leaf"
          className="absolute bottom-[180px] right-[40px] w-[80px] h-[80px] object-contain z-10 max-[342px]:hidden sm:hidden md:block"
        />
        {/* Half Tree — hidden on screens ≤342px and hidden between 640px and 1024px */}
        <img
          src={Halftree}
          alt="Half Tree"
          className="absolute bottom-0 right-0 w-auto h-[960px] sm:h-[400px] object-cover z-0 max-[342px]:hidden sm:hidden md:block"
        />
        <img
          src={BottomBlack}
          alt=""
      ...
      "
        ...
        <img
          src={Queen2}
          alt="Queen 2"
          className="w-[580px] h-[580px] object-contain mb-10 animate-jiggle"
        />
        <img
          src={Halftree}
          alt="Half Tree"
      ...
      " target="_blank" rel="noopener noreferrer" className="inline-block transition-transform duration-300 ease-out hover:scale-110 hover:-translate-y-1">
      ...
      " target="_blank" rel="noopener noreferrer" className="inline-block transition-transform duration-300 ease-out hover:scale-110 hover:-translate-y-1">
        ...
        <img
          src={Leaf}
          alt="Leaf"
          className="absolute bottom-[60px] xl:bottom-[260px] right-[100px] xl:right-[200px] w-[130px] h-[230px] object-contain animate-jiggle"
        />
        <img
          src={Queen2}
          alt="Queen 2"
          className="absolute w-[580px] h-[580px] xl:w-[720px] xl:h-[820px] object-contain left-[1050px] xl:left-[1200px] top-[120px] xl:top-[110px] animate-jiggle"
        />
        <img
          src={BottomBlack}
          alt=""
          className="absolute -bottom-[132px] xl:bottom-0 left-0 w-full xl:h-[225px] h-[260px] object-fill"          
        />
      </div>
    </section>
  );
